...
//		PreparedStatement psForAdmin = conn.prepareStatement(Queries.INSERT_INTO_ADMINS);
//		psForAdmin.setString(1, adminId);
//		psForAdmin.setString(2, adminPassword);
//		psForAdmin.executeUpdate();
	...
	public void updateAdmin() throws SQLException
	{
		...
		String adminId=sc.next();
		System.out.println("Enter the new password for admin : ");
		String adminPassword=sc.next();
...
//		preparedStatement.setString(3, adminMobile);
	...
	public void addReceptionist() throws SQLException {
		// TODO Auto-generated method stub
		String currentDateTime = format.format(date);
		System.out.println("Enter new recepitionist's Id : ");
		...
		PreparedStatement preparedStatement = conn.prepareStatement(Queries.INSERT_QUERY_FOR_USER);
		preparedStatement.setString(1,receptionistId);
